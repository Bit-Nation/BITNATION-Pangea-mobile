    ...
    return (
      ...
      <View style={styles.container}>
        ...
        <View style={styles.wholeText}>
          <Text messageText style={styles.description}>Now that you have written down your private key, we will ask you to verify
            it.</Text>
          <Text messageText style={styles.description}>You will type the 12 words of your private key into the app, and we will
            check that your written private key is correct.</Text>
          <Text messageText style={styles.description}>Your private key protects everything in Bitnation, so be sure to put your
