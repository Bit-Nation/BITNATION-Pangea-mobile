...
class NativeDAppModalScreen extends NavigatorComponent<Props & OwnProps, State> {
...
export default connect(mapStateToProps, mapDispatchToProps)(NativeDAppModalScreen);
