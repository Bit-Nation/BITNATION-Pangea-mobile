...
export default class WalletService {
  ...
  async resolveBalance(wallets: Array<WalletType>, network: string) {
    ...
    walletsToCheck[0].balance = balanceBNEth.times(new BigNumber(10).pow(-19)).toString(10);
    ...
    walletsToCheck[1].balance = balanceBNPAT.times(new BigNumber(10).pow(-19)).toString(10);
