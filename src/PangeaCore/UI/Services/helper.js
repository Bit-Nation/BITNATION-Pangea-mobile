...
export const contractData = [
  {
    ...
    title: 'Producer: BITNATION Americas LTD | Year 2018 | Audited: No | Cost: Standard Ethereum tx fees',
    subTitle: 'Blockchain: Ethereum | Contact: info@bitnation.co',
...
export const productData = [
  {
    ...
    title: 'Producer: BITNATION Americas LTD | Year 2018 | Audited: N/A | Cost: US$149 paid in XPAT',
    subTitle: 'Blockchain: Ethereum | Contact: comms@bitnation.co',
    imageUri: AssetsImages.govMarketItem3,
